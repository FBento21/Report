...
\documentclass[defaultstyle,10pt,Helvetica,twoside]{istulthesis}
%
% -----------------------------------------------------------------------------
...
\cleardoublepage
% \begin{abstract}
% 	\input{./Thesis-MSc-practices.tex}
% \end{abstract}
% \cleardoublepage
\newpage
\input{Thesis-MSc-quote.tex}
\thispagestyle{empty} % the following page without header or footer
\pagebreak % the following page without header or footer
...
%Chapter Math Intro
%\acresetall
\input{./Chapters/Thesis_MSc-Chapter_Math-Intro.tex}
% If Printing on DOUBLE SIDED pages, the second page should be white.
% Otherwise, comment the following command:
%\cleardoublepage
%
...
\appendix
\input{./Chapters/Thesis_MSc-AppendixTrueA.tex}
%% First Appendix
