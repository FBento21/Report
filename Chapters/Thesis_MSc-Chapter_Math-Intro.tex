...
\begin{corollary}[Green's Formulas]
    ...
    \end{enumerate}
\end{corollary} 
Consider the following partial differential equation with null Dirichlet boundary conditions (the Neumann case is analogous)
\begin{equation}
    \begin{cases}
        -\Delta u(x) = \lambda u(x), \text{ in } \Omega\\
