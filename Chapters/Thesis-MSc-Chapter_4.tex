...
% ##########################################################################
\section{Helmholtz Equation in Rectangular Domains using MFS-B}


% ##########################################################################
\section{Helmholtz Equation in Rectangular Domains using MFS-D}


% ##########################################################################
\section{Dirac Operator Spectrum in Rectangular Domains using MFS-B}


% ##########################################################################
\section{Dirac Operator Spectrum in Rectangular Domains using MFS-D}


% ##########################################################################
\section{Dirac Operator Spectrum in General Polygonal Domains using MFS-D}
